...
typedef struct
{
    ble_gap_addr_t      peer_addr;                              /**< BLE GAP address of the peer that initiated the DFU process. */
    ble_gap_addr_t      device_addr;                            /**< BLE GAP address of the device that shall be updated (this device) */
